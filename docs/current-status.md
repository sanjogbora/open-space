...
- Bundle analysis and Repair Center now warn when hotspots, links, object toggles, or finish options have missing content, invalid positions, unsupported URLs, or placeholder texture choices before publish.
